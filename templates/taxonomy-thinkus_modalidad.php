...
$header_title = get_term_meta($category->term_id,'header_title',true)!=''?get_term_meta($category->term_id,'header_title',true): get_option('header_title');
$header_description = $category->description && $category->description!=''?$category->description: get_option('header_description');
$header_image = get_term_meta($category->term_id,'image_header',true) && get_term_meta($category->term_id,'image_header',true)!=''?wp_get_attachment_image_url(get_term_meta($category->term_id,'image_header',true),'full'): get_option('Header_image');
$page_title = get_term_meta($category->term_id,'Page_title',true) && get_term_meta($category->term_id,'Page_title',true)!=''?get_term_meta($category->term_id,'Page_title',true):get_option('page_title');
...
<?php printf('Tenemos  <b>%d ofertas </b> para ti',count($get_offers)); ?>
	...
	<?php
		...
		$get_modificacion = $category->slug;
	?>
